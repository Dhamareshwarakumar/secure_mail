...
$sql="SELECT * FROM messages WHERE recepient={$current_user_id}";
$req=mysqli_query($conn, $sql);
...
<div class="container d-flex flex-column justify-content-center">
	<div class="row justify-content-center">
		<div class="col-12 col-md-6" >
			<h3 class="text-center">Received messages (<?php echo intval(mysqli_num_rows($req)); ?>)</h3>
			<hr>
		</div>
	</div>
</div>
	...
	<table class="table table-hover">
		...
		?>
			<tr>
				...
				<td>
					<?php $sql2="SELECT * FROM users WHERE ID={$row['sender']}";
				...
				<td>
					...
					{
						echo htmlentities($original_plaintext, ENT_QUOTES, 'UTF-8');
					}
					?>
				</td>
			</tr>
			...
			?>
			<tr>
				<td>You have no received messages.</td>
			</tr>
			<?php
			}
			?>
